...
from common.nets.module_wo_face_decoder import PositionNet, HandRotationNet, FaceRegressor, BoxNet, BoxSizeNet, HandRoI, BodyRotationNet
...
class Model(nn.Module):
    def __init__(self, encoder, body_position_net, body_rotation_net, box_net, hand_position_net, hand_roi_net, hand_decoder,
        ...
        self.trainable_modules = [self.encoder, self.body_position_net, self.body_regressor,
                                  ...
                                  self.face_regressor]
        self.special_trainable_modules = [self.hand_decoder]
